...
public class JTableBuilder<E> {
   ...
   private boolean autoRowSorter = false;
   ...
   public JTable build() {
      ...
      if (autoRowSorter) {
         this.table.setAutoCreateRowSorter(autoRowSorter);
      }
      ...
      this.table.setDragEnabled(dragEnabled);
      if (dragEnabled) {
   ...
   public JTableBuilder<E> autoRowSorter() {
      this.autoRowSorter = true;
      return this;
   }

   public JTableBuilder<E> enableDrag() {
   ...
   private void setColumns() {
      for (int i = 0; i < columns.size(); i++) {
         ...
         if (column.getClazz() == Boolean.class) {
            tableColumn.setCellEditor(new BooleanCellEditor());
         }

         if (column.getSortOrder() != null) {
            // JYTableSortController<? extends javax.swing.table.TableModel> rowSorter = (JYTableSortController<?
            // extends javax.swing.table.TableModel>) this.table
            // .getRowSorter();
   ...
   public static class TableModel<T> extends AbstractTableModel {
   ...
   public static class Columns {
      ...
      public static Column<String> WOCHENTAG = ColumnBuilder.get(String.class).add("Tag").editable(false).width(50).build();
   }
